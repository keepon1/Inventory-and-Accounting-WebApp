...
class Permissions:
    ...
    def general_permissions(self):
        ...
        access = {'admin':self.user.admin, 'per_location_access':locations, 'create_access':self.user.create_access,
                'reverse_access':self.user.reverse_access, 'journal_access':self.user.journal_access, 'coa_access':self.user.coa_access, 'item_access':self.user.item_access,
                ...
                'date_access':self.user.date_access
                }
